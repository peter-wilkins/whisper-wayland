...
class TestServiceManager:
    ...
    def test_service_manager_initialization(self, test_config: "ww.Config") -> None:
    ...
    def test_start_service(self, test_config: "ww.Config") -> None:
    ...
    def test_start_service_already_running(self, test_config: "ww.Config") -> None:
    ...
    def test_stop_service(self, test_config: "ww.Config") -> None:
    ...
    def test_stop_service_not_running(self, test_config: "ww.Config") -> None:
    ...
    def test_restart_service(self, test_config: "ww.Config") -> None:
    ...
    def test_restart_service_not_running(self, test_config: "ww.Config") -> None:
    ...
    def test_is_running(self, test_config: "ww.Config") -> None:
    ...
    def test_get_status(self, test_config: "ww.Config") -> None:
    ...
    def test_close(self, test_config: "ww.Config") -> None:
    ...
    def test_close_not_running(self, test_config: "ww.Config") -> None:
    ...
    def test_create_service_manager(self, test_config: "ww.Config") -> None:
