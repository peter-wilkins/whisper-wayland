...
class TestApplication:
    ...
    @unittest.mock.patch("whisper_wayland.application.text_inserter.TextInserter.new")
    @unittest.mock.patch("whisper_wayland.application.key_monitor.KeyMonitor.new")
    @unittest.mock.patch("whisper_wayland.application.transcription_client.TranscriptionClient.new")
    @unittest.mock.patch("whisper_wayland.application.audio_recorder.AudioRecorder.new")
    @unittest.mock.patch("whisper_wayland.application.logging_config.setup_logging")
    @unittest.mock.patch("whisper_wayland.application.config.get_config")
    ...
    def test_app_initialization_with_config_file(  # noqa: PLR0913
        ...
        application.Application("/path/to/config.env")
...
class TestMainFunction:
    ...
    @unittest.mock.patch("whisper_wayland.application.Application")
