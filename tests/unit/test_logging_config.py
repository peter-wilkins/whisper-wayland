...
from whisper_claude.logging_config import setup_logging, get_logger, _configure_third_party_loggers
...
class TestLoggingConfig:
    ...
    def test_setup_logging_info_level(self, config):
    ...
    def test_setup_logging_debug_level(self, config):
    ...
    def test_logging_levels_mapping(self, config):
        ...
        for level_str, level_int in test_levels.items():
            with patch.dict(os.environ, {"OPENAI_API_KEY": "sk-test123", "LOG_LEVEL": level_str}):
                test_config = Config()
